...
export class LanguageService {
  ...
  private loadTranslations(): void {
        ...
        forms: {
          ...
          signup: {
            ...
            errors: {
              ...
              passwordLowercase: "Passwords must have at least one lowercase letter ('a'-'z').",
              passwordUppercase: "Passwords must have at least one uppercase letter ('A'-'Z').",
              passwordNumber: "Passwords must have at least one digit ('0'-'9').",
              passwordSpecial: 'Passwords must have at least one special character.',
              signupComingSoon:
    ...
    this.translations['uk'] = {
      welcome: {
        ...
        features: {
          ...
          community: {
            ...
            description:
              'Спілкуйтеся з іншими, хто вивчає німецьку, діліться улюбленими жартами та святкуйте мовні успіхи разом!',
          },
        },
        actions: {
          login: 'Увійти',
        ...
        forms: {
          ...
          signup: {
            ...
            success: 'Акаунт успішно створено! Тепер ви можете увійти.',
            errors: {
              emailRequired: "Електронна пошта обов'язкова",
              emailInvalid: 'Будь ласка, введіть дійсну електронну пошту',
              userNameRequired: "Ім'я користувача обов'язкове",
              userNameMinLength: "Ім'я користувача повинно містити принаймні 3 символи",
              passwordRequired: "Пароль обов'язковий",
              ...
              validationFailed: 'Будь ласка, перевірте ваші дані та спробуйте ще раз',
              registrationFailed: 'Реєстрація не вдалася. Будь ласка, спробуйте ще раз.',
              passwordLowercase: "Пароль повинен містити принаймні одну малу літеру ('a'-'z').",
              passwordUppercase: "Пароль повинен містити принаймні одну велику літеру ('A'-'Z').",
              passwordNumber: "Пароль повинен містити принаймні одну цифру ('0'-'9').",
              passwordSpecial: 'Пароль повинен містити принаймні один спеціальний символ.',
              signupComingSoon:
      ...
      sections: {
        title: 'Розділи навчання',
        subtitle: 'Оберіть розділ для початку навчання',
        loading: 'Завантаження секцій...',
        error: 'Не вдалося завантажити розділи',
        retry: 'Спробувати знову',
        empty: 'Розділи не знайдено',
        emptyDescription: 'Наразі немає доступних розділів для навчання',
        levels: 'рівнів',
        completed: 'пройдено',
        progress: 'прогрес',
      },
        ...
        forms: {
          ...
          signup: {
            ...
            errors: {
              ...
              emailExists: 'Benutzer mit dieser E-Mail existiert bereits',
              validationFailed: 'Bitte überprüfe deine Eingabe und versuche es erneut',
              ...
              passwordUppercase:
                "Passwörter müssen mindestens einen Großbuchstaben ('A'-'Z') enthalten.",
              passwordNumber: "Passwörter müssen mindestens eine Ziffer ('0'-'9') enthalten.",
              passwordSpecial: 'Passwörter müssen mindestens ein Sonderzeichen enthalten.',
              signupComingSoon:
